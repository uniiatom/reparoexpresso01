...
const _ticketTypes = [
  ('problema_servico', 'Problema com serviço'),
  ('pagamento', 'Pagamento'),
  ('prestador', 'Prestador'),
  ('outro', 'Outro'),
];

/// Porta de `legacy/src/components/ClientTicketForm.jsx`. RLS corrigida na
/// Fase 6 estendida (`20260601150000_tickets_owner_access.sql`) — antes,
/// cliente/prestador não conseguiam nem inserir na tabela `tickets`.
