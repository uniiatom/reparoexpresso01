...
// Ver nota em apps/client/test/widget_test.dart: `AdminApp` dispara uma
...
void main() {
  testWidgets('AppTheme.dark aplica cores da paleta Dark Industrial', (tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: AppTheme.dark,
        home: const Scaffold(body: Text('Reparo Expresso — Admin')),
      ),
    );

    expect(find.text('Reparo Expresso — Admin'), findsOneWidget);
