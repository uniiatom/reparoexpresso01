...
/// Porta de `legacy/src/pages/Login.jsx` para o painel admin. Apenas
/// contas com role `admin`/`attendant` conseguem passar do login — ver
/// guarda de role em `router.dart`.
