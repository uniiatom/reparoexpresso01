...
import { Wrench, Zap, Droplets, Paintbrush, Wind, Lock, Hammer, Settings, Star, Shield, Clock, Car, UserCheck, ClipboardList, BadgeCheck, Smartphone, Waves, Layers, HardHat, Thermometer, ChefHat, Truck, ShowerHead, Pipette, Gift, Heart, Store, Minimize2, Maximize2 } from "lucide-react";
...
const homeServices = [
  ...
  { icon: Hammer, label: "Limpeza de Telhado", subtitle: "Limpeza de cobertura", type: "limpeza_telhado", color: "bg-amber-100 text-amber-700" },
...
const electricalServices = [
  ...
  { label: "Quadros de Distribuição", type: "eletrica_qdc", price: "R$ 100 - R$ 200" },
